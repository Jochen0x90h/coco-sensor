...
class Project(ConanFile):
    name = "coco-air-sensor"
    description = "Sensor module for CoCo"
    license = "MIT"
    ...
    def build_requirements(self):
        ...
        self.test_requires("coco-spi/pow10", options={"platform": self.options.platform})
        self.test_requires("coco-i2c/pow10", options={"platform": self.options.platform})
        self.test_requires("coco-mono-display/pow10", options={"platform": self.options.platform})
